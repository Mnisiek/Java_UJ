...
public class WatkowyEksperymentator1 implements BadaczKostekDoGry {
	...
	public WatkowyEksperymentator1() {
...
//		    return (int) watek.getId();
	...
	public Runnable utworzObiektRunnable() {
	    return new Runnable() {
	        private KostkaDoGry mojaKostka = WatkowyEksperymentator1.this.kostka;
	        private int mojaLiczbaRzutow = WatkowyEksperymentator1.this.liczbaRzutow;
